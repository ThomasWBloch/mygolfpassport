...
| DB-rækker (Portugal) | 118 |
| DB unikke klub-navne | 82 |
| EXACT matches | 50 |
| FUZZY matches (manuel review) | 5 |
| DB_ONLY klubber (ikke i FPG) | 27 (44 rækker) |
| FPG_ONLY (mangler i DB) | 20 |
...
| C. N. F. Golfe do Jamor | C. N. F. Golfe do Jamor | 104 | Lisboa | tier1-lower | 1 |
...
| Campo de Golfe de Cantanhede | Campo de Golfe de Cantanhede | 111 | Zona Centro | tier1-lower | 3 |
...
| Golfe Vale Pisão | Golfe Vale Pisão | 092 | Zona Norte | tier1-lower | 1 |
...
|---|---|---|---|---|---:|
| Clube de Golfe de Vidago | Campo do Clube de Golfe de Vidago | 097 | Zona Norte | DB ⊂ FPG; matched 24 chars | 1 |
| Oeiras Green Valley | Oeiras Green Valley / Academia Municipal de Golfe | 105 | Lisboa | DB ⊂ FPG; matched 19 chars | 1 |
...
| id | name | holes | par | is_combo | golfapi_id |
|---|---|---:|---:|---|---|
| 8b2d9f60-f24e-42b5-b69f-999e5cd0cd02 | Atlantic Championship | 18 |  | false | 0121111417768304 |
| 4a745ff5-3b18-4f73-bde2-9c65ad0f00a7 | Atlantic North | 18 |  | true |  |
